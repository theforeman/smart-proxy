...
class Proxy::Puppet::PuppetApiV2EnvironmentsRetriever < Proxy::Puppet::EnvironmentsRetrieverBase
  def initialize(puppet_url, puppet_ssl_ca, puppet_ssl_cert, puppet_ssl_key, api = nil)
    ...
    @api = api || Proxy::Puppet::EnvironmentsApi.new(puppet_url, ssl_ca, ssl_cert, ssl_key)
  end
end
