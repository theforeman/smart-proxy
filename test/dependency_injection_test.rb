...
class TestDependencyOne
  ...
  def initialize(container = nil); @container = container; end
end
...
class TestDependencies
  ...
  dependency :test_dependency_two, lambda { |container_instance| TestDependencyOne.new(container_instance) }
  singleton_dependency :singleton_dependency, TestDependencyTwo
  singleton_dependency :singleton_dependency_two, lambda { |container_instance| TestDependencyTwo.new(container_instance) }
end
...
class DependencyInjectionTest < Test::Unit::TestCase
  ...
  def test_instance_var_dependency_lambda_receives_container_as_parameter
    assert_equal TestContainer.instance, TestContainer.instance.get_dependency(:test_dependency_two).container
  end
  ...
  def test_singleton_var_dependency_lambda_receives_container_as_parameter
    assert_equal TestContainer.instance, TestContainer.instance.get_dependency(:singleton_dependency_two).container
  end
